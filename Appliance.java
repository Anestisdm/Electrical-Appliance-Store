...
public String toString() {
	return "\nΚωδικός Προιόντος=" + code + "\nΌνομα Μοντέλου=" + model_name +"\nΑρχική Τιμή=" + price+"€"+"\nΈκπτωση="+Math.round(getDiscount()*100)+"%"+"\nΤελική Τιμή="+getDiscountPrice()+"€"+"\nΑπόθεμα="+stock+" τεμμάχια"+ "\nΈτος Μοντέλου=" + model_year + "\nΚατασκευαστής="
			+ manufacturer ;
}
...
public static void Print_Appliances(String Device) {
	...
	System.out.println("-----------------------------------------------------------");
	System.out.print("Δώσε επιλογή (αριθμό): ");
	...
	if (Selected_Appliances.get(input).stock>0) {
		boolean x=false;
		do {
		System.out.println("Το συγκεκριμένο μοντέλο έχει απόθεμα στο καταστημά μας. Θέλετε να πραγματοποιήσετε αγορά; (1:Ναι ή 2:Όχι)");
		System.out.print("Δώσε επιλογή (αριθμό): ");
			int input2=scanner.nextInt();
			if (input2==1) {
				System.out.print("Παρακαλώ εισάγετε πλήθος κομματιών οπου θέλετε να αγοράσετε: (πατήστε 0 για έξοδο) ");
				...
				if (pieces<=Selected_Appliances.get(input).stock) {
					...
					System.out.print("Παρακαλώ εισάγετε το ονοματεπώνυμο σας: [(πχ Βασίλης Παπαδόπουλος) ή πατήστε 0 για έξοδο] ");
					String name=in.nextLine();
					if (name.equals("0")) {
						break;
					}
					System.out.print("Παρακαλώ εισάγετε το τηλέφωνο σας: [(πχ 6947452542) ή πατήστε 0 για έξοδο] ");
					...
					System.out.println("Η αγορά ολοκληρώθηκε επιτυχώς!");
					System.out.println("-----------------------------------------------------------");
					System.out.println(s1);
					x=true;
				}
				else {
					System.out.println("Δεν υπάρχει αρκετό απόθεμα στο κατάστημα μας για να ικανοποιήσει την αγορά σας!");
					break;
				}
			}
			else if (input2==2) {
		...
		try {
			boolean x=false;
			do {
				System.out.println("Δεν υπάρχει απόθεμα για το συγκεκριμένο μοντέλο στο κατάστημά μας. Θέλετε να πραγματοποιήσετε παραγγελία; (1:Ναι ή 2:Όχι)");
				System.out.print("Δώσε επιλογή (αριθμό): ");
				int input2=scanner.nextInt();
				if (input2==1) {
					Scanner in = new Scanner(System.in);
					System.out.print("Παρακαλώ εισάγετε πλήθος κομματιών οπου θέλετε να παραγγείλετε: (πατήστε 0 για έξοδο)");
					int pieces=scanner.nextInt();
					if (pieces==0) {
						break;
					}
					...
					System.out.print("Παρακαλώ εισάγετε αναμενόμενη ημερομηνία άφιξης: [(πχ 2020-05-11) ή πατήστε 0 για έξοδο] ");
...
public static void Overview_Appliances() {
	...
	System.out.println("1.Ήχος και εικόνα");
	System.out.println("2.Gaming");
	System.out.println("3.Οικιακές συσκευές");
	System.out.println("-----------------------------------------------------------");
	System.out.print("Δώσε επιλογή (αριθμό): ");
	int input=scanner.nextInt();
		switch (input) {
