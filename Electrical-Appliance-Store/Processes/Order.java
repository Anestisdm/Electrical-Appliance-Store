...
public String toString() {
	return "Στοιχεία Παραγγελίας \nΚωδικός Παργγελίας=" + order_code + "\nΜοντέλο Συσκευής=" + model + "\nΟνοματεπώνυμο Πελάτη=" + customer_name
			+ "\nΤηλέφωνο Πελάτη=" + customer_phone + "\nΗμερομηνία Παργγελίας=" + order_date + "\nΗμερομηνία Άφιξης Παργγελίας=" + arrival_date
			+ "\nΚόστος=" + order_cost+"€" +"\nΚομμάτια Παραγγελίας="+order_pieces+"\nΚατάσταση Παραγγελίας=" + order_status ;
}

public static void Overview_Orders() {
	Scanner scanner= new Scanner(System.in);
	System.out.println("-----------------------------------------------------------");
	System.out.print("Παρακαλώ εισάγετε τον κωδικό παραγγελίας: (πατήστε 0 για έξοδο) ");
	...
	for(int i=0;i<=Orders.size();i++) {
		...
		if (Orders.get(i)!=null) {
			if(Orders.get(i).order_code==(input)) {
				...
				do {
					System.out.println("-----------------------------------------------------------");
					System.out.print("Πατήστε 1 για άφιξη παραγγελίας & πώληση: (πατήστε 0 για έξοδο) ");
					...
					if (input1==1) {
						y=true;
							...
							System.out.println("-----------------------------------------------------------");
							System.out.println("Η κατάσταση της παραγγελίας ενημερώθηκε!");
							System.out.println("O κωδικός πώλησης είναι: "+s.getSale_code());
						}
					else if (input1==0) {
						break;
					}
				...
				while(y==false);
					...
					System.out.println("-----------------------------------------------------------");
					System.out.println("Η παραγγελία έχει εκτελεστεί!");
				}
			}
		}
	}
	if (x==false) {
		System.out.println("-----------------------------------------------------------");
		System.out.println("Ο κωδικός παραγγελίας που εισάγατε δεν είναι καταχωρημένος!");
	}
}
